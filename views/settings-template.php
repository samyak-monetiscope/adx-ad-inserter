...
if ( ! defined('ADXB_MONETISCOPE_VERSION') ) {
  define('ADXB_MONETISCOPE_VERSION', '4.0.0');
}
...
function adx_v4_settings_page() {
   // Local admin assets (no external CDNs)
wp_enqueue_style(
    'adxbymonetiscope-admin',
    plugins_url( 'css/index.css', dirname(__FILE__) ),
    [],
      ...
      <div class="form-actions">
        ...
        <div class="head banner" style="position: relative; left: -20px;">
          <a href="https://monetiscope.com/contact/" target="_blank" rel="noopener noreferrer">
            ...
            <img src="<?php echo esc_url( plugins_url( 'img/banner2.png', dirname(__FILE__) ) ); ?>" alt="Website" class="rounded-md hover:rounded-none hover:shadow-lg duration-200">
          </a>
        </div>
...
// Register + enqueue tailwind script
