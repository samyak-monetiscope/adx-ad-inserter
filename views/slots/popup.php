...
function adxbymonetiscope_render_popup_slot() {
    ...
    $network_code_js = wp_json_encode($network_code, JSON_UNESCAPED_SLASHES);
...
(function () {
  ...
  } catch (err) { if (console && console.warn) console.warn("Monetiscope popup error:", err); }
})();
<?php
    $js = ob_get_clean();
    wp_add_inline_script('adxbymonetiscope_popup_script', $js, 'after');
}
